...
%-------------------------------------------------------------------------%
%% Butterfly: Animación 3 -> Elementos aleatorios e inclinación -----------
...
Buterfly = figure ('Name','Butterfly - Animación 3',...
                   'NumberTitle','off',...
                   'Color', 'k',...
                   'Menubar','none',...
...
title({'Butterfly: Animación 3 (Incinación y aleatoriedad)'},...
       'Color','w',...
